Implement the feature described in GitHub issue #6:
...
- Apply all relevant instructions from [copilot-instructions.md](http://_vscodecontentref_/2) and [frontend.instructions.md](http://_vscodecontentref_/3)
